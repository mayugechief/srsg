...
class Cms::PublicController < ApplicationController
  module Filter
    ...
    include Cms::PreviewFilter
    include Cms::MobileFilter
    ...
    private
      ...
      def check_mobile
        return if @path !~ /^mobile\//
        @mobile = true
        @path   = @path.sub(/^mobile\//, "")
      end
      ...
      def render_mobile
        ...
        body = replace_mobile_paths body
        response.body = convert_mobile body
      end
